testProxy: testProxy.cpp	httpProxy.cpp Cache.cpp Time.cpp
	g++ testProxy.cpp httpProxy.cpp Time.cpp RequestHeader.cpp ResponseHeader.cpp Cache.cpp  -o testProxy -std=gnu++11 -Wall -Werror -pthread
